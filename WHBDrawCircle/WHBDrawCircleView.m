...
@implementation WHBDrawCircleView
...
- (void)setupColourAnimation{
    ...
    colorBaseAnimation.duration = 0;
    colorShapeLayer.path = self.colorPath.CGPath;
    colorShapeLayer.fillColor = [UIColor clearColor].CGColor;
    colorShapeLayer.strokeColor = [UIColor greenColor].CGColor;//self.colourFillColor.CGColor;
...
- (void)setupNormalAnimation{
    ...
    normalShapeLayer.strokeColor = [UIColor redColor].CGColor;//self.normalFillColor.CGColor;
